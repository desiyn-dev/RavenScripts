/* Constants */
private static final String[] CLIENT_PROFILES = {
    "Raven B4",
    "BlowsyWare", 
    "Custom Profile 1",
    "Custom Profile 2",
...
private static final String BUILD_USER = client.getUser();
private static final String BUILD_NUMBER = String.valueOf(client.getUID());
private static final String BUILD_VERSION = "Private"; // When "Custom" is selected
...
private Map<String, Integer> potionColors;
private Map<String, String> potionNameMap;
...
private static final Map<String, String> POTION_ID_MAP = new HashMap<>();
private static final Map<String, String> POTION_NAME_MAP = new HashMap<>();
private final String[] csgoTextParts = new String[4];
